...
XC_API FARPROC WINAPI XC_GetProcAddress(HMODULE hModule, LPCSTR  lpProcName);
...
XC_API  void WINAPI XC_RegJsBind(const char* pName, int func);
XC_API  void WINAPI XC_RegFunIdle(funIdle func);
...
XC_API BOOL WINAPI XComboBox_GetItemText(HELE hEle, int iItem, int iColumn, out_ wchar_t* pOut, int nOutLen);
XC_API BOOL WINAPI XComboBox_GetItemTextEx(HELE hEle, int iItem, const wchar_t* pName, out_ wchar_t* pOut, int nOutLen);
...
XC_API void WINAPI DebugPrint(int  level, const char *pInfo);
...
XC_API BOOL WINAPI XEditor_SetBreakpoint(HELE hEle, int iPosition, BOOL bActivate = TRUE);       //添加断点
XC_API BOOL WINAPI XEditor_RemoveBreakpoint(HELE hEle, int iPosition);    //添加断点
XC_API void WINAPI XEditor_ClearBreakpoint(HELE hEle);
XC_API BOOL WINAPI XEditor_SetActivateBreakpoint(HELE hEle, int iPosition, BOOL bActivate);    //设置当前命中行
XC_API BOOL WINAPI XEditor_SetRunRow(HELE hEle, int iPosition);
...
XC_API int  WINAPI XEdit_GetTextLength(HELE hEle);
...
XC_API void WINAPI XEdit_AddKeyword(HELE hEle, const wchar_t* pKeyword, COLORREF color);
XC_API BOOL WINAPI XEdit_ClipboardPaste(HELE hEle);    //粘贴 粘贴剪贴板内容
...
//XC_API BOOL WINAPI XEle_RegEventC_js(HELE hEle, int nEvent, const char* pFunName);
//XC_API BOOL WINAPI XEle_RegEventC1_js(HELE hEle, int nEvent, const char* pFunName);
//XC_API BOOL WINAPI XEle_RegEventC2_js(HELE hEle, int nEvent, const char* pFunName);
...
XC_API void WINAPI XLayout_GetLayoutPadding(HELE hEle, PaddingSize_i *pPadding);
...
XC_API BOOL WINAPI XListBox_GetItemText(HELE hEle, int iItem, int iColumn, out_ wchar_t* pOut, int nOutLen);
XC_API BOOL WINAPI XListBox_GetItemTextEx(HELE hEle, int iItem, const wchar_t* pName, out_ wchar_t* pOut, int nOutLen);
...
XC_API BOOL WINAPI XList_GetItemText(HELE hEle, int iItem, int iColumn, out_ wchar_t* pOut, int nOutLen);
XC_API BOOL WINAPI XList_GetItemTextEx(HELE hEle, int iItem, const wchar_t* pName, out_ wchar_t* pOut, int nOutLen);
...
XC_API BOOL WINAPI XList_GetItemInt(HELE hEle, int iItem, int iColumn, int* pOutValue);
XC_API BOOL WINAPI XList_GetItemIntEx(HELE hEle, int iItem, const wchar_t* pName, int* pOutValue);
XC_API BOOL WINAPI XList_GetItemFloat(HELE hEle, int iItem, int iColumn, float* pOutValue);
XC_API BOOL WINAPI XList_GetItemFloatEx(HELE hEle, int iItem, const wchar_t* pName, float* pOutValue);
...
XC_API int  WINAPI XListView_Group_AddItemText(HELE hEle, const wchar_t *pValue);
XC_API int  WINAPI XListView_Group_AddItemTextEx(HELE hEle, const wchar_t* pName, const wchar_t *pValue);
XC_API int  WINAPI XListView_Group_AddItemImage(HELE hEle, HIMAGE hImage);
XC_API int  WINAPI XListView_Group_AddItemImageEx(HELE hEle, const wchar_t* pName, HIMAGE hImage);
...
XC_API int  WINAPI XListView_Item_AddItemText(HELE hEle, int iGroup, const wchar_t *pValue);
XC_API int  WINAPI XListView_Item_AddItemTextEx(HELE hEle, int iGroup, const wchar_t *pName, const wchar_t *pValue);
XC_API int  WINAPI XListView_Item_AddItemImage(HELE hEle, int iGroup, HIMAGE hImage);
XC_API int  WINAPI XListView_Item_AddItemImageEx(HELE hEle, int iGroup, const wchar_t *pName, HIMAGE hImage);
...
XC_API BOOL WINAPI XListView_Item_GetTextEx(HELE hEle, int iGroup, int iItem, const wchar_t* pName, out_ wchar_t* pOut, int nOutLen);
...
XC_API BOOL WINAPI XTree_GetItemText(HELE hEle, int nID, int iColumn, out_ wchar_t* pOut, int nOutLen);
XC_API HIMAGE WINAPI XTree_GetItemImage(HELE hEle, int nID, int iColumn);
XC_API BOOL WINAPI XTree_GetItemTextEx(HELE hEle, int nID, const wchar_t* pName, out_ wchar_t* pOut, int nOutLen);
...
XC_API BOOL WINAPI XJS_RunJS(const char* pJsFile);
XC_API BOOL WINAPI XJS_RunJsString(const char* pString);
...
XC_API void WINAPI XWnd_Move(HWINDOW hWindow, int x, int y);  //获取窗口body坐标
